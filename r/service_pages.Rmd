...
*Budget data is from BPFS as of* `r format(Sys.Date(), format = "%b %d, %Y") `.
...
df <- df %>%
  mutate(`Question 1` = gsub("Explain any budget changes between the Fiscal 2024 CLS Budget and Fiscal 2024 Proposed Budget.",
                             "Explain any budget changes between the Fiscal 2024 CLS Budget and Fiscal 2024 Proposed Budget.\n\n", 
                              `Question 1`),
         `Question 2` = gsub("Explain any staffing changes between the Fiscal 2024 CLS Budget and Fiscal 2024 Proposed Budget.", 
                             "Explain any staffing changes between the Fiscal 2024 CLS Budget and Fiscal 2024 Proposed Budget.\n\n", 
                             `Question 2`),
         `Question 3` = gsub("Describe how these changes impact service delivery.", 
                             "Describe how these changes impact service delivery.\n\n", 
                             `Question 3`))
...
df <- data %>%
  ...
  mutate(`Question 4` = str_replace(`Question 4`, "4. ", ""),
         `Question 4` = gsub("Action Plan does this service connect to?", 
                             "Action Plan does this service connect to?\n\n", 
                             `Question 4`),
          `Question 5` = gsub("Action Plan does this service connect to?", 
                              "Action Plan does this service connect to?\n\n", 
                              `Question 5`),
          `Question 6` = gsub("List specific actions planned for FY2024 that are tied to these goals and actions.", 
                              "List specific actions planned for FY2024 that are tied to these goals and actions.\n\n", 
                              `Question 6`))
...
df <- data %>%
  ...
  mutate(`Question 7` = str_replace(`Question 7`, "7. ", ""),
         ...
         `Question 7` = gsub("How does this service address these disparities?",
                             "How does this service address these disparities?\n\n",
                             `Question 7`),
        `Question 8` = gsub("What data is used to assess the service's impact on reducing these disparities?",
                   "What data is used to assess the service's impact on reducing these disparities?\n\n",
                   `Question 8`))
...
df <- data %>%
  ...
  mutate(`Question 9` = str_replace(`Question 9`, "9. ", ""),
         ...
         `Question 9` = gsub("If possible, provide examples of how this service is doing this currently or has done this in the past.",
                             "If possible, provide examples of how this service is doing this currently or has done this in the past.\n\n", 
                             `Question 9`))
...
```{r curve, echo = FALSE, warning = FALSE}
